...
//     // 各色のマーカーをフォーマットとして個別に登録
//     markerColors.forEach((marker, index) => {
...
//                         type: `text-marker/marker-${marker.name}`,
//                     });
//                     onChange(newValue);
//                 };
...
//     // マーカー削除ボタン
//     registerFormatType('text-marker/clear', {
//         title: 'マーカーを削除',
//         tagName: 'mark',
//         className: null,
//         edit({ value, onChange }) {
...
//                     newValue = removeFormat(
//                         newValue,
//                         `text-marker/marker-${marker.name}`
//                     );
//                 });
//                 onChange(newValue);
//             };
...
//     console.log('Text Marker plugin loaded');
